              ...
              <View style ={styles.container}>
                  <View style={styles.header}>
                      <View style={styles.leftContent}>
                          <Text style={styles.headerText}>Hello, Zoharah!</Text>
                          <Text style={styles.subHeadText}>Female, 23</Text>
                      </View>
                      <View style={styles.rightContent}>
                          <FontAwesomeIcon icon={faBell} size={30} color={Theme.colors.ui.nurseGray}/>
                      </View>
                  </View>
                  <View style={styles.searchBarHolder}>
                      <TextInput placeholder="search health services" style={styles.search}/>
                  ...
                  >
                    <View style={styles.headerBgLayer}>
                        ...
                        <Text style={styles.brandMessage}>proffesionals</Text>
